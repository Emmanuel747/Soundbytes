...
const SoundBytes = () => {
  ...
  <SafeAreaView style={styles.container}>
    ...
    <Image source={{
      ...
      <TextInput style={{height: 60, width: 320, margin: 12, borderWidth: 3, padding: 10, fontSize: 24, color: 'red'}}
      ...
      />
      {/*This 'enter' button will take in the inputted username and password and check the database for a profile*/}
      <Button onPress={() => Validate(username, password)} title="Enter"/>
      </View>
...
const Validate = (username: string, password: string) =>{
  if(username.localeCompare("hello") == 0 && password.localeCompare("goodbye") == 0){
    console.log("You entered the right name and password " + correctAttempts + " times")
