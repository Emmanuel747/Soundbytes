        ...
        <div className="user_options-container">
          <div className="user_options-text">
            <div className="user_options-unregistered">
              <h2 className="user_unregistered-title">Don't have a SoundBytes🎙 account?</h2>
            ...
            <div className="user_options-registered">
              <h2 className="user_registered-title">Have a SoundBytes🎙 account?</h2>
          ...
          <div className="user_options-forms" id="user_options-forms">
            <div className="user_forms-login">
              ...
              {/* The Login Form */}
              <form className="forms_form" onSubmit={(e) => {handleSignIn( e, username, password)}}>
                <fieldset className="forms_fieldset">
                  <div className="forms_field">
                    <input type="email" className="forms_field-input" required 
                      onChange={(event) => {
                ...
                <div className="forms_buttons">
                  ...
                  <button type="button" className="forms_buttons-forgot" style={{color: 'red'}}
                    onClick={devLogin}
                  >
            ...
            <div className="user_forms-signup">
              ...
              {/* The Sign Up Form */}
              <form className="forms_form" onSubmit={(e) => {handleSignUp( e, username, password, email)}}>
                <fieldset className="forms_fieldset">
                  <div className="forms_field">
